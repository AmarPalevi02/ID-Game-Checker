...
import { getPUBG } from '../../utils/fetch'
...
const RootPUBG = () => {
   ...
   const handleSubmit = async () => {
      ...
      setError(null);
      try {
         const response = await getPUBG(form.id);
   ...
   return (
      <div className=' w-full flex justify-center flex-col items-center relative'>
         <HeadPage>
            <p className='text-gray-400 py-3 bg-glass px-2'>Untuk mencari dan mengecek userID atau UserName dari game PUBGM cukup mudah, anda tinggal isi ID anda di bawah ini dan klik Checker</p>
         </HeadPage>
